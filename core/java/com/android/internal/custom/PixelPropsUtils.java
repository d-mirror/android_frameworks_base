...
public class PixelPropsUtils {
    ...
    static {
        ...
        propsToChangePixel8Pro.put("ID", "AP1A.240405.002.B1");
        propsToChangePixel8Pro.put("FINGERPRINT", "google/husky/husky:14/AP1A.240405.002.B1/11677284:user/release-keys");
